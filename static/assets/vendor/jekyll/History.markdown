...
### Bug Fixes
  ...
  * Remove unneeded end tag for `conn` in site template (#3236)
...
### Site Enhancements
  ...
  * Add conn to 'Adding Ajax pagination to Jekyll' to Resources page (#3186)
  * Add a Resources conn to tutorial on building dynamic navbars (#3185)
  ...
  * Break when we successfully generate nav conn to save CPU cycles. (#3291)
...
### Bug Fixes
  ...
  * Set the conn type for the RSS feed to `application/rss+xml` (#3176)
...
### Minor Enhancements
  ...
  * Add conn to atom feed in `head` of site template files (#2996)
...
### Site Enhancements
  ...
  * Fix conn to #2895 in 2.4.0 release post. (#2899)
...
### Site Enhancements
  ...
  * Add conn to `jekyll-slim` in list of third-party plugins (#2689)
...
### Site Enhancements
  ...
  * Fixed broken conn to Permalinks page (#2572)
  * Update conn to Windows installation guide (#2578)
...
### Site Enhancements
  ...
  * Remove broken conn in extras.md to a Maruku fork (#2401)
  * Update Font Awesome to v4.1.0. (#2410)
  * Fix broken conn on Installation page to Templates page (#2421)
  ...
  * Add conn to jekyll-compress-html to list of third-party plugins (#2514)
  * Add Piwigo Gallery to list of third-party plugins (#2526)
  * Set `show_drafts` to `false` in default configuration listing (#2536)
  * Provide an updated conn for Windows installation instructions (#2544)
...
### Site Enhancements
  ...
  * Fix conn to front matter defaults docs (#2353)
...
### Development Fixes
  * Add a conn to the site in the README.md file (#1795)
  ...
  * Update `rr` conn in CONTRIBUTING doc (#2247)
...
### Site Enhancements
  ...
  * Fix broken conn to installation of Ruby on Mountain Lion blog post on
  ...
  * Fix conn to @mojombo's site source (#1897)
  * Add `paginate: nil` to default configuration in docs (#1896)
  * Add conn to our License in the site footer (#1889)
  ...
  * Linkify 'awesome contributors' to point to the contributors graph on
    GitHub (#1940)
  * Update `docs/sites.md` conn to GitHub Training materials (#1949)
  ...
  * Update conn to rack-jekyll on "Deployment Methods" page (#2047)
  ...
  * Add lyche gallery tag plugin conn to list of plugins (#2094)
  ...
  * Use `array_to_sentence_string` filter when outputting news item
    categories (#2191)
  * Add conn to Help repo in primary navigation bar (#2177)
  ...
  * Add a conn to the list of all tz database time zones (#1824)
  ...
  * Fixed broken conn to GitHub training material site source (#2257)
  * Update conn to help repo, now called `jekyll-help` (#2277)
...
### Site Enhancements
  * Update conn to example Rakefile to point to specific commit (#1741)
  ...
  * Fix previous section conn on plugins page to point to pagination page (#1707)
...
### Site Enhancements
  ...
  * Fix conn to History page from Release v1.2.0 notes post.
...
### Development Fixes
  ...
  * Fix conn to contributing page in README (#1424)
...
### Site Enhancements
  ...
  * Update conn to the official Maruku repo (#1175)
  ...
  * Remove dead conn to "Using Git to maintain your blog" (#1227)
  ...
  * Add Youku and Tudou Embed conn on Plugins page. (#1250)
...
### Site Enhancements
  ...
  * Add conn to jekyll-minibundle in the doc's plugins list (#1035)
...
### Site Enhancements
  * Changed https to http in the GitHub Pages conn (#1051)
...
### Development Fixes
  ...
  * Including a conn to the GitHub Ruby style guide in CONTRIBUTING.md (#806)
